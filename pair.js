        ...
        sock.ev.on("connection.update", async ({ connection, lastDisconnect }) => {
            if (connection === "open") {
                try {
                    ...
                    // 🆕 1.5️⃣ Send the actual creds.json file as a Document
                    await delay(2000); // Thoda break taaki session string pehle chali jaye
                    await sock.sendMessage(jid, {
...
╰━━━━━━━━━━━━━━┈⊷`;
                    ...
                    await sock.sendMessage(
                      jid,
                      {
                        image: { url: "https://i.ibb.co/h1Dz858Y/file-00000000417071f79e64d5ec09f2119c.png" },
                        caption,
                        contextInfo: {
                          mentionedJid: [jid],
                          forwardingScore: 999,
                    ...
                    // 4️⃣ Cleanup (Badhaya hua delay taaki file send hone ka poora time mile)
                    await delay(5000);
                    rm(dir);
